...
(define scanner-spec-call-by-refs
...
(define scan&parse
  (sllgen:make-string-parser scanner-spec-call-by-refs grammar-call-by-refs))

(define repl
  (sllgen:make-rep-loop "--> "
                        (lambda (pgm) (value-of-program pgm))
                        (sllgen:make-stream-parser scanner-spec-call-by-refs grammar-call-by-refs)))
