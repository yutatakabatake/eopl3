...
; extend-env-recをprocedural representationで実装
; procudureもprocedural representationで実装
...
(define extend-env-rec
  (lambda (saved-p-name saved-b-var saved-body saved-env)
    (lambda (search-var)
      (if (eqv? search-var saved-p-name)
          (proc-val (procedure saved-b-var saved-body (extend-env-rec saved-p-name saved-b-var saved-body saved-env)))
          (apply-env saved-env search-var)))))
